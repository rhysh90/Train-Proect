...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#221ee6dd#;
   ...
   u00056 : constant Version_32 := 16#eddf79ef#;
   pragma Export (C, u00056, "projdefsS");
   u00057 : constant Version_32 := 16#36fe0b10#;
   pragma Export (C, u00057, "widgetB");
   u00058 : constant Version_32 := 16#7f8e1a2d#;
   ...
   u00112 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00112, "ada__integer_text_ioB");
   u00113 : constant Version_32 := 16#f1daf268#;
   pragma Export (C, u00113, "ada__integer_text_ioS");
   u00114 : constant Version_32 := 16#f6fdca1c#;
   pragma Export (C, u00114, "ada__text_io__integer_auxB");
   u00115 : constant Version_32 := 16#b9793d30#;
   pragma Export (C, u00115, "ada__text_io__integer_auxS");
   u00116 : constant Version_32 := 16#18d57884#;
   pragma Export (C, u00116, "system__img_biuB");
   u00117 : constant Version_32 := 16#afb4a0b7#;
   pragma Export (C, u00117, "system__img_biuS");
   u00118 : constant Version_32 := 16#e7d8734f#;
   pragma Export (C, u00118, "system__img_llbB");
   u00119 : constant Version_32 := 16#ee73b049#;
   pragma Export (C, u00119, "system__img_llbS");
   u00120 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00120, "system__img_lliB");
   u00121 : constant Version_32 := 16#e581d9eb#;
   pragma Export (C, u00121, "system__img_lliS");
   u00122 : constant Version_32 := 16#0e8808d4#;
   pragma Export (C, u00122, "system__img_llwB");
   u00123 : constant Version_32 := 16#471f93df#;
   pragma Export (C, u00123, "system__img_llwS");
   u00124 : constant Version_32 := 16#428b07f8#;
   pragma Export (C, u00124, "system__img_wiuB");
   u00125 : constant Version_32 := 16#c1f52725#;
   pragma Export (C, u00125, "system__img_wiuS");
   u00126 : constant Version_32 := 16#7ebd8839#;
   pragma Export (C, u00126, "system__val_intB");
   u00127 : constant Version_32 := 16#bc6ba605#;
   pragma Export (C, u00127, "system__val_intS");
   u00128 : constant Version_32 := 16#b3aa7b17#;
   pragma Export (C, u00128, "system__val_lliB");
   u00129 : constant Version_32 := 16#6eea6a9a#;
   pragma Export (C, u00129, "system__val_lliS");
   u00130 : constant Version_32 := 16#06052bd0#;
   pragma Export (C, u00130, "system__val_lluB");
   u00131 : constant Version_32 := 16#13647f88#;
   pragma Export (C, u00131, "system__val_lluS");
   u00132 : constant Version_32 := 16#91613c5c#;
   pragma Export (C, u00132, "ada__real_timeB");
   u00133 : constant Version_32 := 16#87ade2f4#;
   pragma Export (C, u00133, "ada__real_timeS");
   u00134 : constant Version_32 := 16#1f99af62#;
   pragma Export (C, u00134, "system__arith_64B");
   u00135 : constant Version_32 := 16#d4b08bf7#;
   pragma Export (C, u00135, "system__arith_64S");
   u00136 : constant Version_32 := 16#30bb6e97#;
   pragma Export (C, u00136, "system__taskingB");
   u00137 : constant Version_32 := 16#8d6ada58#;
   pragma Export (C, u00137, "system__taskingS");
   u00138 : constant Version_32 := 16#01715bc2#;
   pragma Export (C, u00138, "system__task_primitivesS");
   u00139 : constant Version_32 := 16#f4bb5b54#;
   pragma Export (C, u00139, "system__os_interfaceS");
   u00140 : constant Version_32 := 16#2c7d263c#;
   ...
   u00142 : constant Version_32 := 16#e2725713#;
   pragma Export (C, u00142, "system__task_primitives__operationsB");
   u00143 : constant Version_32 := 16#12291044#;
   ...
   u00145 : constant Version_32 := 16#c90ea50e#;
   ...
   u00147 : constant Version_32 := 16#cc621349#;
   pragma Export (C, u00147, "system__multiprocessorsS");
   u00148 : constant Version_32 := 16#77769007#;
   pragma Export (C, u00148, "system__task_infoB");
   u00149 : constant Version_32 := 16#232885cd#;
   pragma Export (C, u00149, "system__task_infoS");
   u00150 : constant Version_32 := 16#ab9ad34e#;
   pragma Export (C, u00150, "system__tasking__debugB");
   u00151 : constant Version_32 := 16#f1f2435f#;
   ...
   u00157 : constant Version_32 := 16#95828afa#;
   pragma Export (C, u00157, "system__img_enum_newS");
   u00158 : constant Version_32 := 16#118e865d#;
   pragma Export (C, u00158, "system__stack_usageB");
   u00159 : constant Version_32 := 16#00bc3311#;
   pragma Export (C, u00159, "system__stack_usageS");
   u00160 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00160, "system__ioB");
   u00161 : constant Version_32 := 16#6a8c7b75#;
   pragma Export (C, u00161, "system__ioS");
   u00162 : constant Version_32 := 16#aae0185d#;
   pragma Export (C, u00162, "exec_loadB");
   u00163 : constant Version_32 := 16#482fa4fb#;
   pragma Export (C, u00163, "exec_loadS");
   u00164 : constant Version_32 := 16#f533f6df#;
   pragma Export (C, u00164, "calendarS");
   u00165 : constant Version_32 := 16#7dbbd31d#;
   pragma Export (C, u00165, "text_ioS");
   u00166 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00166, "system__img_boolB");
   u00167 : constant Version_32 := 16#0117fdd1#;
   pragma Export (C, u00167, "system__img_boolS");
   u00168 : constant Version_32 := 16#5933ea28#;
   pragma Export (C, u00168, "system__tasking__protected_objectsB");
   u00169 : constant Version_32 := 16#63b50013#;
   pragma Export (C, u00169, "system__tasking__protected_objectsS");
   u00170 : constant Version_32 := 16#001f972c#;
   pragma Export (C, u00170, "system__soft_links__taskingB");
   u00171 : constant Version_32 := 16#e47ef8be#;
   ...
   u00197 : constant Version_32 := 16#55221100#;
   pragma Export (C, u00197, "system__address_imageS");
   u00198 : constant Version_32 := 16#2bce1226#;
   pragma Export (C, u00198, "system__memoryB");
   u00199 : constant Version_32 := 16#adb3ea0e#;
